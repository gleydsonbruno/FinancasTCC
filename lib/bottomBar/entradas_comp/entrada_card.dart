...
class EntradaCard extends StatefulWidget {
  final EntradaModel entradaItem;
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text(
           '+ ${utilServices.priceToCurrency(widget.entradaItem.value)}', style: TextStyle(
            fontSize: 15,
        ...
        trailing: IconButton(
          ...
          onPressed: () {
             showDialog(
                ...
                builder: (_) {
                  return AlertDialog(
                    title: Text('${widget.entradaItem.description}'),
                  );
                });
          },
        ),
